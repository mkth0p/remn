...
FIELD_MAP: dict[str, str] = {
    "TargetUserName": "targetUser", "TargetDomainName": "targetDomain", "TargetUserSid": "targetSid",
    "TargetSid": "targetSid", "TargetLogonId": "targetLogonId", "TargetServerName": "targetServer",
    "TargetInfo": "targetInfo", "TargetLinkedLogonId": "targetLinkedLogonId", "TargetOutboundUserName": "targetOutboundUser",
    "TargetOutboundDomainName": "targetOutboundDomain",
    "SubjectUserName": "subjectUser", "SubjectDomainName": "subjectDomain", "SubjectUserSid": "subjectSid",
    "SubjectLogonId": "subjectLogonId",
    "LogonType": "logonType", "LogonProcessName": "logonProcess", "AuthenticationPackageName": "authPackage",
    "LmPackageName": "lmPackage", "ElevatedToken": "elevatedToken", "ImpersonationLevel": "impersonationLevel",
    "KeyLength": "keyLength", "RestrictedAdminMode": "restrictedAdminMode", "VirtualAccount": "virtualAccount",
    "IpAddress": "ipAddress", "IpPort": "ipPort", "WorkstationName": "workstation", "ClientAddress": "ipAddress",
    "ClientName": "workstation", "Workstation": "workstation", "Address": "ipAddress", "SourceNetworkAddress": "ipAddress",
    "SourceAddress": "sourceIp", "SourcePort": "sourcePort", "DestAddress": "destinationIp", "DestPort": "destinationPort",
    "Status": "status", "SubStatus": "subStatus", "FailureReason": "failureReason", "FailureCode": "status",
    "ProcessName": "processName", "NewProcessName": "processName", "NewProcessId": "newProcessId",
    "ProcessId": "callerProcessId", "CommandLine": "commandLine", "ParentProcessName": "parentProcessName",
    "ParentProcessId": "parentProcessId", "TokenElevationType": "tokenElevationType", "MandatoryLabel": "mandatoryLabel",
    "ServiceName": "serviceName", "ServiceFileName": "serviceFile", "ImagePath": "serviceFile", "ServiceType": "serviceType",
    "StartType": "serviceStartType", "AccountName": "serviceAccount", "ServiceAccount": "serviceAccount",
    "TaskName": "taskName", "TaskContent": "taskContent", "TaskContentNew": "taskContent",
    "MemberName": "memberName", "MemberSid": "memberSid", "PrivilegeList": "privilegeList",
    "ShareName": "shareName", "ShareLocalPath": "shareLocalPath", "RelativeTargetName": "relativeTargetName",
    "ObjectName": "objectName", "ObjectType": "objectType", "ObjectServer": "objectServer", "AccessMask": "accessMask",
    "AccessList": "accessList", "ObjectValueName": "objectValueName", "NewValue": "newValue", "OldValue": "oldValue",
    "ObjectDN": "objectDn", "ObjectClass": "objectClass", "AttributeLDAPDisplayName": "attributeName",
    "AttributeValue": "attributeValue", "OperationType": "operationType",
    "TicketEncryptionType": "ticketEncryption", "TicketOptions": "ticketOptions", "PreAuthType": "preAuthType",
    "TransmittedServices": "transmittedServices", "ServiceSid": "serviceSid",
    "ScriptBlockText": "scriptBlockText", "ScriptBlockId": "scriptBlockId", "Path": "path", "MessageNumber": "messageNumber",
    "MessageTotal": "messageTotal", "Payload": "payload", "ContextInfo": "contextInfo",
    "DeviceDescription": "deviceDescription", "DeviceId": "deviceId", "ClassName": "className", "ClassId": "classId",
    "VendorIds": "vendorIds", "CompatibleIds": "compatibleIds", "LocationInformation": "locationInformation",
    "PreviousTime": "previousTime", "NewTime": "newTime", "SubcategoryGuid": "subcategoryGuid",
    "SubcategoryId": "subcategoryId", "AuditPolicyChanges": "auditPolicyChanges", "CategoryId": "categoryId",
    "Channel": "channelCleared", "BackupPath": "backupPath",
    "SamAccountName": "samAccountName", "DisplayName": "displayName", "UserPrincipalName": "upn",
    "HomeDirectory": "homeDirectory", "ScriptPath": "scriptPath", "UserAccountControl": "userAccountControl",
    "AllowedToDelegateTo": "allowedToDelegateTo", "SidHistory": "sidHistory", "PasswordLastSet": "passwordLastSet",
    "AccountExpires": "accountExpires", "PrimaryGroupId": "primaryGroupId", "OldTargetUserName": "oldTargetUser",
    "NewTargetUserName": "newTargetUser",
    "SessionID": "sessionId", "SessionName": "sessionName", "User": "user", "Reason": "reason",
    "Param1": "param1", "Param2": "param2", "Param3": "param3", "Param4": "param4",
    "param1": "param1", "param2": "param2", "param3": "param3", "param4": "param4",
    # Sysmon
    "Image": "image", "ParentImage": "parentImage", "ParentCommandLine": "parentCommandLine", "OriginalFileName": "originalFileName",
    "Hashes": "hashes", "CurrentDirectory": "currentDirectory", "IntegrityLevel": "integrityLevel", "LogonGuid": "logonGuid",
    "TerminalSessionId": "terminalSessionId", "ProcessGuid": "processGuid", "ParentProcessGuid": "parentProcessGuid",
    "DestinationIp": "destinationIp", "DestinationPort": "destinationPort", "DestinationHostname": "destinationHostname",
    "SourceIp": "sourceIp", "SourceHostname": "sourceHostname", "Protocol": "protocol", "Initiated": "initiated",
    "QueryName": "query", "QueryResults": "queryResults", "QueryStatus": "queryStatus",
    "TargetFilename": "targetFilename", "TargetObject": "targetObject", "Details": "details", "EventType": "eventType",
    "ImageLoaded": "imageLoaded", "Signed": "signed", "Signature": "signature", "SignatureStatus": "signatureStatus",
    "SourceImage": "sourceImage", "TargetImage": "targetImage", "GrantedAccess": "grantedAccess", "CallTrace": "callTrace",
    "SourceProcessId": "sourceProcessId", "TargetProcessId": "targetProcessId", "StartAddress": "startAddress",
    "StartModule": "startModule", "StartFunction": "startFunction", "PipeName": "pipeName", "Device": "device",
    "RuleName": "ruleName", "UtcTime": "utcTime", "CreationUtcTime": "creationUtcTime", "PreviousCreationUtcTime": "previousCreationUtcTime",
    "Company": "company", "Description": "description", "Product": "product", "FileVersion": "fileVersion",
    "Consumer": "wmiConsumer", "Filter": "wmiFilter", "Destination": "wmiDestination", "Query": "wmiQuery",
    "Operation": "operation", "Name": "name", "Type": "type", "Contents": "contents", "Archived": "archived",
    "IsExecutable": "isExecutable",
    # Defender
    "Threat Name": "threatName", "Threat ID": "threatId", "Severity Name": "severityName", "Category Name": "categoryName",
    "Process Name": "processName", "Detection User": "subjectUser", "Action Name": "actionName", "Origin Name": "originName",
    "Source Name": "sourceName", "Detection Source": "detectionSource", "Old Value": "oldValue", "New Value": "newValue",
    "Detection ID": "detectionId", "Path": "path",
    # RDP / WinRM / others
    "ClientIP": "ipAddress", "Client IP": "ipAddress", "ClientIPAddress": "ipAddress", "IPString": "ipAddress",
    "Username": "targetUser", "UserName": "targetUser", "Domain": "targetDomain", "DomainName": "targetDomain",
    "SourceName": "sourceName", "Destination": "destination", "url": "url", "Url": "url", "URL": "url",
    "ConnectionName": "connectionName", "ConnectionType": "connectionType", "TargetIPAddress": "destinationIp",
    "TargetPort": "destinationPort", "RuleId": "ruleId", "RuleName": "ruleName", "ApplicationPath": "applicationPath",
    "ModifyingApplication": "modifyingApplication", "ModifyingUser": "subjectUser", "Direction": "direction",
    "Action": "action", "Profiles": "profiles", "LocalPorts": "localPorts", "RemotePorts": "remotePorts",
    "RemoteAddresses": "remoteAddresses", "LocalAddresses": "localAddresses", "FilePath": "path", "FileHash": "hashes",
    "Fqbn": "fqbn", "PolicyName": "policyName", "TargetUser": "targetUser", "TargetProcessName": "processName",
    "ClientProcessId": "callerProcessId", "Operation": "operation", "ResultCode": "status", "Application": "application",
    "Layer": "layer", "FilterRTID": "filterId", "LayerRTID": "layerId", "RemoteMachineID": "remoteMachineId",
    "RemoteUserID": "remoteUserId", "Data": "dataList",
}
...
def iter_events(path_or_file: Any, include_raw: bool = True, stats: Stats | None = None,
                number_of_threads: int = 0) -> Iterator[dict[str, Any]]:
    """
