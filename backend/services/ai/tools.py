...
TOOLS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "function": {
            ...
            "parameters": {
                "type": "object",
                "properties": {"filter": _FILTER_PARAM, "field": {"type": "string"}, "limit": {"type": "integer"}},
                "required": ["field"],
            },
        },
    },
    {
        ...
        "function": {
            ...
            "parameters": {
                "type": "object",
                "properties": {"filter": _FILTER_PARAM, "bucket": {"type": "string", "enum": ["minute", "hour", "day"]}, "limit": {"type": "integer"}},
                "required": ["bucket"],
            },
        },
    },
    ...
    },
    {
        ...
        "function": {
            ...
            "parameters": {
                "type": "object",
                "properties": {"filter": _FILTER_PARAM, "bucket": {"type": "string", "enum": ["minute", "hour", "day"]}},
                "required": ["bucket"],
            },
        },
    },
    ...
    },
    {
        ...
        "function": {
            ...
            "parameters": {
                "type": "object",
                "properties": {"severity": {"type": "string"}, "source": {"type": "string", "enum": ["events", "mails"]}, "limit": {"type": "integer"}},
            },
        },
    },
    {
    ...
    },
    {
        ...
        "function": {
            ...
            "parameters": {
                "type": "object",
                "properties": {"kind": {"type": "string", "enum": ["ip", "domain", "url", "hash"]}, "value": {"type": "string"}},
                "required": ["kind", "value"],
            },
        },
    },
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "decision": {"type": "string", "enum": ["reviewed", "escalated", "false_positive", "confirmed", "benign", "unsure"]},
                    "include": {"type": "boolean"},
                    "unlink_finding_ids": {"type": "array", "items": {"type": "integer"}},
                    "reason": {"type": "string"},
                },
                "required": ["reason"],
            },
