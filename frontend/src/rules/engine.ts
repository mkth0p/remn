...
const OPS = new Set<string>(['eq', 'ne', 'in', 'nin', 'contains', 'not_contains', 'contains_any', 'contains_all', 'startswith', 'not_startswith', 'endswith', 'not_endswith', 're', 'not_re', 'gt', 'gte', 'lt', 'lte', 'exists', 'empty', 'in_setting', 'nin_setting'])
